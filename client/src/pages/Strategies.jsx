...
const blank = { name: '', description: '', approach: '', risk_scope: '', entry_criteria: '', exit_criteria: '', status: 'Ativo' };
  ...
  return (
    <div>
      <Header
        ...
        actions={<Btn onClick={openCreate}>Nova estratégia</Btn>}
      />
        ...
        <div className="cards">
          {items.map((s) => (
            <div className="card" key={s.id}>
              <div className="kv"><span className="k">Nome</span><span className="v">{s.name}</span></div>
